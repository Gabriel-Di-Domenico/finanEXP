...
@NgModule({
  declarations: [CustomersComponent, CustomerListComponent, ContentComponent, CustomerEdtiorDialogComponent, CustomerDetailsDialogComponent, MoreCustomersOptionsComponent],
  imports: [
    CommonModule,
    FormsModule,
    ReactiveFormsModule,
